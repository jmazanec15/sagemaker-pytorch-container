...
def create_docker_image(optbin_link, processor, framework_version, python_version):
    ...
    subprocess.call(['cp', output_file, '{}/../docker/{}/final'.format(PATH_TO_SCRIPT, framework_version)])
    subprocess.call(['sudo', DOCKER, 'build', '-t', 'preprod-pytorch:{}-{}-{}'.format(framework_version, processor, py_v), \
